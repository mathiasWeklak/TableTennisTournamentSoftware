...
public class PairingEngineTest {
    ...
    public void testInitialState_matchesAndAllMatchesAreEmpty() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2), 1, TournamentMode.SWISS);
    ...
    public void testGetPlayersWithBye_differentByePlayers_returnsAll() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2, p3), 1, TournamentMode.SWISS);
    ...
    public void testGenerateAllPairings_fourPlayers_returnsSixPairings() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2, p3, p4), 2, TournamentMode.SWISS);
    ...
    public void testGenerateAllPairings_emptyList_returnsEmptyList() {
        PairingEngine engine = new PairingEngine(new ArrayList<>(), 1, TournamentMode.SWISS);
    ...
    public void testGeneratePairings_swissSystem_evenPlayers_generatesMatch() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2), 1, TournamentMode.SWISS);
        String text = engine.generatePairings(1);
        assertNotNull(text);
        assertEquals(1, engine.getMatches().size());
        assertEquals(1, engine.getAllMatches().size());
    }
    ...
    public void testGeneratePairings_swissSystem_oddPlayers_generatesOneByeAndOneMatch() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2, p3), 2, TournamentMode.SWISS);
        String text = engine.generatePairings(1);
        assertNotNull(text);
    ...
    public void testGeneratePairings_swissSystem_allPairsPlayed_returnsNull() {
        ...
        engine.generatePairings(1);
        engine.clearCurrentRound();
        String text = engine.generatePairings(2);
        assertNull(text);
        assertTrue(engine.isFinished());
    }
    ...
    public void testGeneratePairings_roundRobin_round1_twoPlayers_generatesMatch() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2), 1, TournamentMode.ROUND_ROBIN);
        String text = engine.generatePairings(1);
        assertNotNull(text);
        assertEquals(1, engine.getMatches().size());
    }
    ...
    public void testGeneratePairings_roundRobin_oddPlayers_roundBeyondMax_returnsNull() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2, p3), 1, TournamentMode.ROUND_ROBIN);
        String text = engine.generatePairings(4);
        assertNull(text);
        assertTrue(engine.isFinished());
    }
    ...
    public void testGeneratePairings_roundRobin_oddPlayers_round1_addsByeMatch() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2, p3), 2, TournamentMode.ROUND_ROBIN);
        String text = engine.generatePairings(1);
        assertNotNull(text);
        assertTrue(text.contains("Freilos"));
    }
    ...
    public void testRoundRobin_evenPlayers_allPairsGenerated() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2, p3, p4), 2, TournamentMode.ROUND_ROBIN);
        Set<String> seenPairs = new HashSet<>();
        int round = 1;
        String text = engine.generatePairings(round);
        while (text != null) {
            ...
            engine.clearCurrentRound();
            round++;
            text = engine.generatePairings(round);
        }
    ...
    public void testRoundRobin_oddPlayers_correctNumberOfRounds() {
        ...
        PairingEngine engine = new PairingEngine(List.of(p1, p2, p3, p4, p5), 2, TournamentMode.ROUND_ROBIN);
        int round = 1;
        String text = engine.generatePairings(round);
        while (text != null) {
            engine.clearCurrentRound();
    ...
    public void testRoundRobin_oddPlayers_eachPlayerGetsExactlyOneBye() {
        ...
        PairingEngine engine = new PairingEngine(players, 2, TournamentMode.ROUND_ROBIN);
    ...
    public void testRoundRobin_twoPlayers_exactlyOneRound() {
        PairingEngine engine = new PairingEngine(List.of(p1, p2), 1, TournamentMode.ROUND_ROBIN);
        assertNotNull(engine.generatePairings(1));
        engine.clearCurrentRound();
        assertNull(engine.generatePairings(2));
        assertTrue(engine.isFinished());
    }
